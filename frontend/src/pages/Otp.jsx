      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            maxLength={6}
            placeholder="000000"
            className="w-full border border-slate-300 rounded-md px-3.5 py-2.5 tracking-[0.5em] text-center text-xl font-medium text-slate-800 placeholder:tracking-normal placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600"
            value={otp}
