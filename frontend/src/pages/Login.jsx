...
export default function Login() {
  ...
  return (
    <AuthLayout title={t("Sign in")} subtitle={t("Enter your PPO number and password to continue")}>
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              id="captcha_answer"
              inputMode="numeric"
              className="flex-1 border border-slate-300 rounded-md px-3.5 py-2.5 text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600"
              value={captchaAnswer}
